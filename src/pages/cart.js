...
export default function CartPage() {
    ...
    const [isRedirecting, setRedirecting] = useState(false); // By default this will be false
    async function onCheckout() {
        if (cartCount > 0) {
            ...
            } finally { // This is going to make sure that setRedirecting is set to false whether it resolves successfully in the try part or the catch part
